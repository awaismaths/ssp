function [usol,ex_sol]=timestepping(tol,zc,uc,bmm,dW,aec,Area_CE,int_all,GBE_indices,BE_indices,all_cg,ncell,n,X,Mass,A,cell_e,Ndt,dt,mesh,h)
itermax=1000;
forcediff=1;
...
save(strcat('solutions/BM',num2str(bmm),'mesh',mesh(5:7),'tcuz',num2str(uc),num2str(zc)),'usol_idt','dt','Ndt','mesh','h');
end