...
meshes={'mesh1_1.mat'};%'mesh1_2.mat';'mesh1_3.mat'};%'mesh1_4.mat'};%'mesh1_05.mat';'mesh1_06.mat';'hexa1_5.mat'};
...
fine_mesh=matfile(strcat('../HHO-Lapl-OM-master/matlab_meshes//',meshes{nbmeshes}));
...
%      end;
  ...
  load(strcat('BM/BM_mesh',num2str(nbmeshes)),'WF');
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for bmm=1:nbm
        timestepping(tol,zc,uc,bmm,W(:,bmm),aec,Area_CE,int_all,GBE_indices,BE_indices,all_cg,ncell,n,X,Mass,A,cell_e,Ndt(imesh),dt,meshes{imesh},h);
    %Following error only works in the case of deterministic problem. Also, uncomment the correct source in the "timestepping". 
    Sol=load(strcat('solutions/BM',num2str(bmm),'mesh',meshes{imesh}(5:7),'tcuz',num2str(uc),num2str(zc)));;
    Sol=Sol.usol_idt;
    %Exact solution
